...
DESIRED_SERVICES: list[str] = [
    ...
    # CodeFilesService — reference data. Initial grant covered some but
    # several return 403 even after approval; re-requesting explicitly.
    "CodeFilesService.getBillingCode",
    "CodeFilesService.getDeductionCodeDetails",
    "CodeFilesService.getPaycodeDetails",
    "CodeFilesService.getDepartmentCode",
    "CodeFilesService.getDivisionCode",
    "CodeFilesService.getNAICSCodeList",
    "CodeFilesService.getEeoCodes",
    "CodeFilesService.getPayGrades",
    "CodeFilesService.getHolidayCodeList",
    "CodeFilesService.getEventCodes",
    "CodeFilesService.getShiftCode",
    "CodeFilesService.getPositionCode",
    "CodeFilesService.getProjectCode",
    "CodeFilesService.getClientCategoryList",
    "CodeFilesService.getContactTypeList",
    "CodeFilesService.getCourseCodesList",
    "CodeFilesService.getSkillCode",
    "CodeFilesService.getRatingCode",
    "CodeFilesService.getProjectPhase",
    "CodeFilesService.getPositionClassifications",
    "CodeFilesService.getUserDefinedFields",
